...
use anvil_zksync_common::utils::cost::{format_gwei, format_mdx};
...
"#,
            BANNER.custom_color(color).bold(),
            VERSION_MESSAGE.green(),
            "matter-labs/anvil-zksync".green()
        );

        // Rich Accounts.
        let balance = format_mdx(self.genesis_balance);
...
"#,
            ...
            sh_println!(
                r#"
MedoxieChain Network Configuration
========================
Chain ID: {}
"#,
                self.chain_id
...
"#,
        ...
        sh_println!(
            r#"
MedoxieChain Node Configuration
========================
Port:                  {}
EVM Interpreter:       {}
